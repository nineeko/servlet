package com.neeko.chap03responselecturesource.section01.response;
...
public class ResponseTest extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        * 2. 비지니스 로직을 처리한다. => DB 접속 및 CRUD 로직 수행
        * 3. 응답을 처리한다.
        ...
        * */
        ...
        /* tomcat 10 버전 이상부터는 MIME type만 기재해도 문자셋이 자동으로 utf-8 설정 */
        resp.setContentType("text/html");

        // 사용자 브라우저에 응답하기 위한 출력 스트림을 resp에서 반환받는다.
